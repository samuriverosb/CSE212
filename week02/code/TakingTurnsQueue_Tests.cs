...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People are being added to the front of the queue instead of the back. People with Infinite turns aren't being re-added to the queue.
    ...
    // Defect(s) Found: Negatives weren't being considered as infinite turns. People with Infinite turns aren't being re-added to the queue.
    ...
    // Defect(s) Found: Empty queue condition was not being checked.
